...
public class CameraUtils {
    ...
    public void create(final SurfaceView surfaceView, final Context context) {
    ...
    public void createCMR(SurfaceView surfaceView, Context context) {
        this.context = context;
        this.surfaceView = surfaceView;
    }
